...
/*PMON版本V1.0.1  和利时自定义版本 更新PMON版本修改此处*/
#define	PMON_VER_V0	  1
#define	PMON_VER_V1	  0
#define	PMON_VER_V2	  1
...
//#define COM1_BASE_ADDR	0xbfe00300
...
#	define PMON_VER_OFFS 508 	/* Ethernet address base */
