# 1 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
...
/ {
 ...
 memory {
  name = "memory";
  device_type = "memory";
  reg = <0 0x00200000 0 0x0c800000
   1 0x10000000 0 0x10000000>;
...
# 67 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
  dc@0x400c0000 {
...
# 89 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
  ohci@0x40070000 {
...
# 440 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
  can0: can@1fe00c00{
   ...
   nxp,clock-out-frequency = <100000>;
  };
  can1: can@1fe00d00{
   compatible = "nxp,sja1000";
   reg = <0x1fe00d00 0xff>;
...
# 542 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
  sdio@0x1fe0c000 {
   #address-cells = <1>;
   #size-cells = <1>;
...
# 615 "/media/fsy/09C1B27DA5EB573A/2k/hls/pmon-loongson3/zloader.ls2k/../Targets/LS2K/conf/LS2K.dts"
 };
